...
#[cfg(windows)]
pub fn set(enabled: bool, start_hidden: bool) -> crate::core::error::Result<()> {
...
#[cfg(not(windows))]
pub fn set(_enabled: bool, _start_hidden: bool) -> crate::core::error::Result<()> {
    Err(crate::core::error::OracleError::Other(
